    ...
    <div id="modalAddGenre" class="modal2">
        ...
        <div class="modal-body">
            ...
            <form id="formAddGenre" action="index.php?action=modifierFilm&id=<?= $film['id_film'] ?>" method="POST" enctype="multipart/form-data">
                ...
                <!-- Ajouter Genre -->
                <div>
                    <input type="text" name="genre" placeholder="Nom du genre" minlength="1" maxlength="50" size="20" required autocomplete="off">
                </div>
        ...
        <div class="modal-body">
            ...
            <form id="formAddRealisateur" action="index.php?action=modifierFilm&id=<?= $film['id_film'] ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="addPersonne">
                    ...
                    <input type="text" id="nom" name="nom" required minlength="1" maxlength="50" size="20" autocomplete="off">
                    <!-- Prenom -->
                    <label for="prenom">Prénom</label>
                    <input type="text" id="prenom" name="prenom" required minlength="1" maxlength="50" size="20" autocomplete="off">
                    <!-- Sexe -->
                    <legend>Sexe</legend>
                    <select name="sexe">
    ...
    <div id="modalAddRole" class="modal2">
        ...
        <div class="modal-body">
            ...
            <form id="formAddRole" action="index.php?action=modifierFilm&id=<?= $film['id_film'] ?>" method="POST" enctype="multipart/form-data">
                ...
                <!-- Ajouter Role -->
                <div>
                    <input type="text" name="role" placeholder="Nom du rôle" minlength="1" maxlength="50" size="20" required autocomplete="off">
                </div>
        ...
        <form class="formulaire" action="index.php?action=modifierFilm&id=<?= $film['id_film'] ?>" method="POST" enctype="multipart/form-data">
            ...
            <div>
                <div class="affiche">
                    ...
                    <img id="output" />
                    <script>
                        // script pour avoir le preview de l'affiche insérée
            ...
            <div>
                ...
                <div class="titre">
                    ...
                    <input type="text" id="titre" name="titre" required minlength="1" maxlength="50" size="30" value="<?= $film['titre'] ?>" autocomplete="off">
                </div>

                <!-- Note -->
                <div class="note">
                    <label for="note">Note</label>
                    <input type="number" id="note" name="note" required min="0" max="5" size="30" step="0.1" value="<?= $film['note'] ?>" autocomplete="off">
                </div>

                <!-- Durée -->
                <div class="duree">
                    <label for="duree">Durée (minutes) :</label>
                    <input type="number" id="duree" name="duree" required min="1" step="1" value="<?= $film['duree'] ?>" autocomplete="off">
                </div>
